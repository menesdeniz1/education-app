...
class PlayRememberNumsCardActivity : AppCompatActivity() {
    ...
    private fun startGame() {
        ...
        generateDigits(6) // Generate 4 random digits
    ...
    private fun checkInput() {
        ...
        if (userInput.isNotEmpty()) {
            val userDigits = userInput.toCharArray().map { it.toString().toInt() }
